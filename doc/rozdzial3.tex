...
\section{Wybrane metody}
\label{sec:metody}

\subsection{Flux Tensor with Split Gaussian Models}
W artykule \cite{6910016}
\subsection{Weightless Neutral Networks}
Praca \cite{6910014}
\subsection{Self-tuning Background Subtraction Algorithm}
Informacje o rozwiązaniu można znaleźć w artykule \cite{6910012}
\subsection{SuBSENSE}
\cite{stflexible}
\subsection{Spectral-360}
